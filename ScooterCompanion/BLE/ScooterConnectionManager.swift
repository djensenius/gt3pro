...
final class ScooterConnectionManager: NSObject, @unchecked Sendable {
    ...
    /// Old Nordic UART service write (B5A3-0002) — the official app uses this for auth
    var oldWriteCharacteristic: CBCharacteristic?
    /// Old Nordic UART service notify (B5A3-0003) — the official app listens here for auth response
    ...
    private static let peripheralUUIDKey = "ScooterCompanion.peripheralUUID"
    ...
    func beginAuthentication() {
        ...
        // Strip leading emoji/whitespace because iOS may decorate the advertised name.
