        ...
        Section {
            ...
            if !logStore.entries.isEmpty {
                ...
                ShareLink(
                    ...
                    preview: SharePreview("ScooterCompanion-debug.log")
                ) {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: Theme.Spacing.large) {
                ...
                Text("""
Scooter Companion collects ride telemetry (speed, battery, GPS route, surface \
...
the scooter manufacturer or any other third party.
...
struct LicensesView: View {
    private let licenses: [(String, String)] = [
        ...
        ("Scooter Companion", "David Jensenius — Apache 2.0")
    ]
